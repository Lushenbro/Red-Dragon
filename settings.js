...
global.ownername = "😎lushen bro❯❯" // owner name
global.ytname = "" // lushen bro yt channel
...
global.botname = 'lushen - 𝘉𝘖𝘛' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "lushen edition " // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉ lushen official ]' //

//database
global.premium = ['+94710654826'] //ur premium numbers
...
global.mess = {
    ...
    caption: 'Generated by: ◉ *lushen bro edition*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
...
global.rep = { // All Replies = 145
    ...
    K3: '😉🫶හායි😂',hi
    K4: '🥴හූයි😊',hui
    K5: '😂හේයි, හව් ආ යූ🥴✌️',hey how are you
    K6: '😁Hey there💝 I am WhatsApp Bot😏',
    K7: '❣️ඇයි හලෝ😌',aii hello
    K8: '🙃මොකෝ හලෝ🥲',moko hello
    K9: '😒මොකෝ?',moko
    K10: '🥺ඇයි අනේ?❤️🫢',aii ane
    K11: '🌝❤️',
    K12: '😜හී හී😁හූ හූ',hii hii hu hu
    K13: '😁හී හී💞',hii hii
    K14: '😊හූ...',huu
    K15: 'ඇයි🥲',aii
    K16: '😂😂✌️',
    K17: '😐ආහ්',ah
    K18: 'චූටී තමයි😇',chuti thama
    K19: '🥺🥺ඇයි සුදූ❤️💓',aii sudu
    K20: 'කොහොමවත් නෑ ඉතිං😒',kohomavath na ithin
    K21: '😁මන් දන්නෑ🥲',man danne na
    K22: 'හොඳයි තමා😌',hodai thama
    K23: '😂😂මරු හැබැයි',maru habai
    K24: 'මලු🙃',malu
    K25: '😘😇❤️',
    K26: '😘😘මෙන්න ඔයාට💕',menna oyata
    K27: '😊ඇත්තමද?❤️',aththamada
    K28: '☺️👻ඔය ඇත්තමද❤️',oya aththamada
    K29: 'ඇයි🙄',aii
    K30: '🥺✌️සිදෙනවද?',ridenavada
    K31: '😐💔ඕවට එන්න එපා හරිත😒',ovata enna epa harida
    K32: '😏අනේ මේ😒 යනෝ යන්න💔',ane me yano yanna
    K33: 'ඔයා තමයි හොරා😒 මගෙ හිත හොරකම් කළානෙ ඉතිං😌',oya thama hora mage hitha horakam kalane
    K34: '😇මොකො හූම් ගාන්නෙ😒 බකමූනා',moko hmm ganne bakamuna
    K35: '​😁😁මොකෝ හලෝ හූම් හූම් ගාන්නෙ?',moko hallo hmm hmm ganne
    K36: '😉නෑ අනේ මුකුත් නෑ😐🫠',naa ane mukuth naa
    K37: '😒ආහ්',ah
    K38: '✌️ඔව් නං එච්චරයි😌',ow na echcharai
    K39: '😐හේ හේ නැද්ද?🫣',hey hey heta nadda
    K40: '🙄මොනවටද ආස?',monavatada asa
    K41: '😌මාත් ආසයි😊💞',math asai
    K42: 'එල😌',ela
